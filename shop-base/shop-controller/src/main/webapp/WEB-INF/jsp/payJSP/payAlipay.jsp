...
body {
	...
	background-image:url(/staticIndex/images/background/parallax.jpg);
	background-size:100%;
}
...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<h1>有鞋商城 - 支付宝电脑网站支付</h1>
	</header>
	<div id="main">
		<br/>
		<!-- 网页支付  -->
		<form name=alipayment action="${basePath }/Pay/payByAlipay" method=post target="_blank">
			<div id="body1" class="show" name="divcontent" style="margin-left:600px;margin-right:600px;">
				<dl class="content">
					<dt>订单编号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" readonly="readonly" value="${orderPay.orderid}"/>
					</dd>
					<hr class="one_line">
					<dt>订单时间 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" readonly="readonly" value='<fmt:formatDate value="${orderPay.ordertime}" pattern="yyyy-MM-dd HH:mm:ss" />' />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" readonly="readonly" value="${orderPay.total}"  />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" readonly="readonly" value="${orderPay.orderItemList[0].producItem.pname}......"/>
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
