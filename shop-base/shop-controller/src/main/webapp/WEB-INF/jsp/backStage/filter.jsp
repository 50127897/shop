...
<div class="login-form">
  ...
  <form id="login-form" action="${pageContext.request.contextPath}/backstage/login" method="post" onsubmit="return checkLoginForm()">
    <div class="key">
      <input type="text" id="username" name="ename" placeholder="请输入账号" value="admin1" >
    </div>

    <div class="key">
      <input type="password" id="password" name="epassword" placeholder="请输入密码" value="admin1">
    </div>
