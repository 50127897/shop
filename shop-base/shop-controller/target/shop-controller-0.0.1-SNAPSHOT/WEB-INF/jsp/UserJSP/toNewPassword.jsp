                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
								<h2>更改密码</h2>
			                    <form role="form" action="${basePath}/newPassword" method="post" class="login-form">
			                    <input type="hidden" name="uuid" value="${user.code}"/>
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">用户名</label>
			                    		<span class="form-username form-control">${user.username} </span>
<!-- 			                        	<input type="text" name="username" placeholder="用户名/邮箱" class="form-username form-control" id="form-username"> -->
			                        ...
			                        <div class="form-group">
			                    		...
			                    		<span class="form-username form-control">${user.email} </span>
<!-- 			                        	<input type="text" name="username" placeholder="用户名/邮箱" class="form-username form-control" id="form-username"> -->
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">新密码</label>
			                        	<input type="password" name="passwd" placeholder="新密码" class="form-password form-control" id="form-password">
			                        </div>
                        ...
                        <div style="float: left;margin-top: 25px;margin-left: 20px;"><a href="${basePath}/User/forgotPassword" style="text-align: right;"><h3>忘记密码</h3></a></div>                        	
