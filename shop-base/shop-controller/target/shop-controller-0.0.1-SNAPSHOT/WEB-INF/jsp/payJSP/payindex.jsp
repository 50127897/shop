...
<body>
						...
						<ul class="main-menu menu">
							...
							<li class="menu-item menu-item-has-children dropdown"><a
								...
								<ul class="sub-menu">
									...
									<c:if test="${not empty user }">
										<li class="menu-item menu-item-has-children dropdown"><a href="#">客服</a></li>
	...
	<div style="background:#E1FFFF;">
		<br/>
		<div class="ps-widget__header" style="margin-left:800px;">
		  <h3>请选择支付方式:</h3>
		</div>
		<br/>
		<div class="ps-widget__content" style="margin-left:950px;">
		  <ul class="ps-list--checked">
		  	<li><a href="${basePath }/Pay/toPayAlipay?orderid=${orderid}">支付宝</a></li>
			<li><a href="#">银行卡</a></li>
			<li><a href="#">其他方式</a></li>
		  </ul>
		</div>
		<br/>
		<div class="ps-widget__header" style="margin-left:910px;">
		  <h5><strong>安全防盗提示</strong></h5>
		</div>
		<div class="ps-widget__header" style="margin-left:800px;">
		  <h5><strong>(1)</strong>不要将信用卡的信息写在电脑里；</h5>
		  <h5><strong>(2)</strong>不要将信用卡轻易交给别人；</h5>
		  <h5><strong>(3)</strong>信用卡丢失后，立刻打银行客服电话进行挂失；</h5>
		  <h5><strong>(4)</strong>如果发现某些异常消费，只要提出证据，是可以拒付的。</h5>
		  <h5><strong>(5)</strong>如果你认为通过告知信用卡的卡号、有效期等信息有危险，建议大家使用网上支付方式进行付款.</h5>
		</div>
		<br/>
	</div>
