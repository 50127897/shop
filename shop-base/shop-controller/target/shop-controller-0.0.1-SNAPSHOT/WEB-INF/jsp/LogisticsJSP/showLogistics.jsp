						...
						<div class="ps-review">	
							<div class="ps-review__content">
								<table class="table table-hover table-bordered">
									<tr>
										<font style="font-family:verdana;color:#2F4F4F;font-size:20px;">订单编号:&nbsp;</font>
										<font style="font-family:verdana;color:#006400;font-size:23px;">
											<strong>${orderid}</strong>&nbsp;
										</font>
										<font style="font-family:verdana;color:#2F4F4F;font-size:20px;">的物流信息如下:&nbsp;</font>
									</tr>
									<hr/>
									<tr style="background: silver;">
										<td style="margin-left:500px;width:350px;text-align:center;padding-left:40px;">
											<h5><strong><font style="font-family:verdana;color:#2F4F4F;font-size:20px;">更新时间</font></strong></h5>
										</td>
										<td style="padding-left:10px;width:350px;text-align:center;">
											<h5><strong><font style="font-family:verdana;color:#2F4F4F;font-size:20px;">物流状态</font></strong></h5>
										</td>
										<td style="width:550px;text-align:center;">
											<h5><strong><font style="font-family:verdana;color:#2F4F4F;font-size:20px;">物流实时地址</font></strong></h5>
										</td>
									</tr>
									<c:forEach items="${logisticsList}" var="logistics">
										<tr class="success">
											<td style="margin-left:500px;width:350px;padding-left:115px;"><h5><strong><fmt:formatDate value="${logistics.lodate}" pattern="yyyy-MM-dd HH:mm:ss" /></strong></h5></td>
											<td style="margin-left:500px;width:350px;padding-left:120px;">
												<h5>
													<strong>
											...
											<td style="width:550px;text-align:center;"">
												<h5><strong>${logistics.loaddress}</strong></h5>
											</td>
										</tr>
									</c:forEach>
								</table>
								<a href="javascript:history.go(-1)"><button type="button" class="btn btn-success">返回上一页面</button></a>
								<br/><br/><br/>
							</div>
						</div>
					</div>
